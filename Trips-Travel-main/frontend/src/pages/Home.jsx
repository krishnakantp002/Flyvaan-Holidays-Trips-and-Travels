    ...
    <>
      <div className="min-h-screen bg-cover md:pt-4 px-6 md:px-12 bg-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <div className="my-8">
              <h1 className="text-[33px] font-Arial text-center md:text-[40px] md:text-start font-bold mb-4 ">
                Plan Your Perfect Trip with{" "}
                <span className="text-BaseColor text-[40px] font-Arial">
                  FLYVAAN HOLIDAYS
                </span>
              </h1>
              <p className="text-lg leading-8 text-gray-800 hidden md:block">
                "Welcome to FLYVAAN HOLIDAYS, your go-to destination for
      ...
      <section className="py-8 text-center px-6 md:px-12">
        ...
        <p className="text-lg leading-8 mb-8 text-gray-800">
          "Unveil travel wonders in our gallery, a snapshot of FLYAAN HOLIDAYS's
          adventures."
        </p>
        <ImagesGallery />
      </section>
